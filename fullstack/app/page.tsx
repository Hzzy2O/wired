...
export default function Home() {
	...
	useEffect(() => {
		const fetchCoins = async () => {
			try {
				const creator = "0x5115666b5dc37b13697798e4245bc5aa9d2083a4b00b6123cefe757a1f21444f";
				const response = await fetch(`/api/coin?creator=${creator}`);
			...
			<div className="relative z-10">
				<div className="min-h-screen flex items-center justify-center">
					<div className="relative w-full h-[100vh]">
						{!loading
							? positions.slice(0, coins.length).map((position, index) => {
									const style = {
										...position,
